...
public class DTOfertaLaboral {
	...
	public DTOfertaLaboral(String nombre, String descripcion, String ciudad, String departamento, String horario, float remuneracion, float costoAsociado, DTTipo dataTipo, Map<String, DTKeyword> dataKeywords) {
		this.nombre = nombre;
