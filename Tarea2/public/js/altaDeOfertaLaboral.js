...
formulario.addEventListener('submit', function(e) {
	...
	const horarioValidado = validarCampo(inputs[1].value, 'horario'); 
	const remuneracionValidada = validarCampo(inputs[2].value, inputs[2].name);
	...
	//Validacion si paga en general
  	 			...
  	 			&& keywordsValidado && descripcionValidado && tipoCompraValidado) {
		mandarForm();
	}
});
