	...
	<div class="row justify-content-md-center">
		<div class="col-xs-12 col-md-10">
			<div id="registrarContainer" class="d-flex flex-column min-vh-100 justify-content-center">
				...
				<!-- Formulario -->
				<form action="AltaDeUsuario" method="POST" class="formulario" id="formulario" onsubmit="return validarForm()">
...
<script src="https://kit.fontawesome.com/a3b19d1f5c.js" crossorigin="anonymous"></script>
<script src="../media/javaScriptaltaDeUsuarioValidacion"></script>