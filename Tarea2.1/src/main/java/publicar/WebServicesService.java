 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://publicar/", wsdlLocation = "http://localhost:9127/webservices?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9127/webservices?wsdl");
